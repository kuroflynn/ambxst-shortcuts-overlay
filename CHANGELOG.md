...
- Compatibility recorded as tested on Ambxst base `af9f8ad4...` (tag `1.3.3`); patch applies verbatim there. Pending: native activation and real-session runtime validation.
